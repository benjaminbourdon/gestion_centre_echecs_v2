...
class TournamentDynamicMenu(DynamicMenu):
    ...
    def request_participant_id(self):
        ...
        tournament = self.app.managers["TournamentManager"].get_tournament_by_id(tournament_id)
        participants_id = [participant.federal_id for participant in tournament.participants]
        list_choicies = {
        ...
        federal_id = self.app.view.select_info(list_choicies, "Joueurs ne participant pas encore :")
